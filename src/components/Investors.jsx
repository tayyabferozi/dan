const Investors = () => {
  return (
    <div className="section-padding" id="investors">
      <div className="container-xl">
        <div className="row">
          <div className="col-md-6">
            <div className="left">
              <img src="./assets/vectors/domains.svg" alt="domains" />
            </div>
          </div>
          <div className="col-md-6">
            <div className="right">
              <h2>Here for domain investors too</h2>
              <p className="mb-4">
                As a domain investor, you have particular needs. We get it! So
                we built a special platform just for domain investors. With its
                clear interface, bulk domain name uploading and editing

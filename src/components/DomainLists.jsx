...
const DomainLists = () => {
  return (
    <div className="text-center section-padding" id="domain-lists">
      <div className="container-xl">
        <div className="row">
          <div className="col-md-4">
            <div className="domain-card">
              <div className="img">
                <img src="./assets/vectors/flame.svg" alt="flame" />
              </div>
              <div className="text">
                <h3>Popular domain names</h3>
                <p className="mb-0">
          ...
          <div className="col-md-4">
            <div className="domain-card">
              <div className="img">
                <img src="./assets/vectors/cards.svg" alt="cards" />
              </div>
              <div className="text">
                <h3>3-letter domain names</h3>
                <p className="mb-0">
          ...
          <div className="col-md-4">
            <div className="domain-card">
              <div className="img">
                <img src="./assets/vectors/premium.svg" alt="premium" />
              </div>
              <div className="text">
                <h3>Premium domain names</h3>
                <p className="mb-0">
                  Premium domain names are usually short, easy to brand, and use
                  a popular extension like .com.
                </p>
                <a href="#0">
